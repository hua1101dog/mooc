...
export const constantRoutes = [
  ...
  // },
  {
    ...
    children:[{
      path: '/system/project/sysmsg',
      component: () => import('@/views/project/system/index'),
      name: 'home',
      meta: { title: '首页ss', icon: 'documentation', affix: true }
    }],
  },
  {
    path: '/work',
  ...
  {
    path: '/commonConfig',
    component: () => import('@/views/work/commonConfig/index'),
    hidden: true
  },
  {
    path: '/userInfo',
    component: () => import('@/views/index-page/userInfo/index'),
    hidden: true
  },
  {
    path: '/showDetail/:id',
    component: () => import('@/views/index-page/showDetail/index'),
    hidden: true
  }
];
