        ...
        <div class="register_form_content">
          <div>
            <el-form-item prop="username">
              ...
              <el-input ref="username" v-model="registerForm.username" style="width:98%" size="large" placeholder="输入用户名">
            ...
            <button class="button_regCode_register" style="width:100%;margin-bottom:30px;" @click.prevent="save">确定</button>
...
import { sendCodeForget, forgetPassword } from '@/api/register';
export default {
  name: 'ForgetPassword',
  inject: ['reload'],
  data() {
  ...
  methods: {
    ...
    registerDone() {
      ...
      this.$nextTick(() => {
        const params = {
          ...
          passwordTwo: this.registerForm.confirmPassword
        };
    ...
    getCode() {
      const TIME_COUNT = 60;
      if (this.registerForm.username) {
        sendCodeForget({ username: this.registerForm.username }).then(res => {
          if (res.code == 0) {
